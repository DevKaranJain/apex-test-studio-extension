...
const getOrgInfo_1 = require("./cli/getOrgInfo");
async function activate(context) {
    console.log('Congratulations, your extension "apex-test-studio" is now active!');
    const disposable = vscode.commands.registerCommand('apex-test-studio.apex-test-studio', async () => {
        console.log('In extension file in registered command');
        try {
            const orgIdentifier = await (0, getOrgInfo_1.getDefaultOrg)();
